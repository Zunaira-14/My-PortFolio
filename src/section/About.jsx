  ...
  return (
    ...
    >
      ...
      <div className="max-w-5xl w-full bg-gradient-to-br border bg-blend-lighten bg-gradient-to-br from-[#030303] via-[#4f4f51] to-[#313131] border-slate-800 rounded-3xl shadow-xl p-8 md:p-12">
        ...
        <div className="grid md:grid-cols-[1.1fr,1.3fr] gap-8 mb-10">
          ...
          <div className="text-gray-300 font-medium text-sm sm:text-base leading-relaxed">
            <p>
              ...
              from Pakistan, passionate about turning ideas into clean,
              user‑friendly digital products. I specialize in building scalable
              web applications using modern JavaScript frameworks, focusing on
              writing maintainable code and delivering smooth, high-performance
              experiences for real users. I thrive in collaborative environments
              and enjoy solving complex problems with elegant, efficient
              solutions.
            </p>
          </div>
        </div>
        ...
        <div className="grid md:grid-cols-2 gap-8 mb-10">
          <div className="font-medium">
            ...
            <p className="text-gray-300 text-sm sm:text-base leading-relaxed">
              ...
              , where I contributed to building modern, responsive websites and
              learned real‑world development workflows, collaboration and
              problem solving. I closely followed industry best practices, used
              GitHub for version control and participated in code reviews to
          ...
          <div className="font-medium">
            ...
            <p className="text-gray-300 text-sm sm:text-base leading-relaxed">
              ...
              through  code expert self‑learning, real projects and professional training. I
              am currently pursuing a{" "}
              <span className="font-semibold text-white">
                BS in Computer Science
              </span>{" "}
              to strengthen my foundations in programming, software engineering
          ...
          <div className="grid sm:grid-cols-2 gap-6">
            ...
            <div className="group bg-gradient-to-r border border-slate-800 rounded-2xl p-5 
              ...
              <p className="text-gray-300 text-sm leading-relaxed">
                ...
                clean layouts, reusable components and smooth
                micro‑interactions.
              </p>
            </div>
            ...
            <div className="group bg-gradient-to-r border border-slate-800 rounded-2xl p-5 
              ...
              <p className="text-gray-300 text-sm leading-relaxed">
                ...
                <span className="font-semibold">Node.js</span> and{" "}
                <span className="font-semibold">Express</span>, and work with{" "}
                <span className="font-semibold">MongoDB</span> to store and
            ...
            <div className="group bg-gradient-to-r border border-slate-800 rounded-2xl p-5 
              ...
              <p className="text-gray-300 text-sm leading-relaxed">
                Take a project from idea to deployment, including auth, routing,
                dashboards and integrations, ensuring frontend and backend stay
                in sync.
              </p>
            </div>
            ...
            <div className="group bg-gradient-to-r border border-slate-800 rounded-2xl p-5 
              ...
              <p className="text-gray-300 text-sm leading-relaxed">
                Collaborate using GitHub, manage tasks into clear milestones,
                and debug calmly to deliver reliable features on time.
              </p>
            </div>
          </div>
        </div>
        ...
        {/* Why Hire Me section inside the same card */}
        <WhyHireMe />
      </div>
    </section>
  );
